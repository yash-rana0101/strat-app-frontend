    ...
    <div className="fixed inset-0 z-9999 flex items-center justify-center bg-black/40 dark:bg-black/60 backdrop-blur-md select-none p-4">
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-border-default/40 bg-surface/50 dark:bg-black/20">
          ...
          <button
            onClick={onClose}
            className="rounded-lg p-1 text-text-muted hover:bg-elevated/80 hover:text-text-primary transition-colors flex items-center justify-center"
            title="Close"
          >
            <X size={16} />
          </button>
        ...
        <div
          ref={listRef}
          className="flex-1 overflow-y-auto max-h-87.5 divide-y divide-border-default/10 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
        >
          {isSearching && (
          ...
          {!isSearching && searchError && (
            <div className="text-center py-8 text-xs text-rose-600 dark:text-rose-400 font-semibold">
              {searchError}
            </div>
          )}
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <span className="w-24 font-bold text-xs truncate text-text-primary">
