...
export default function EmptyState({ symbol, compact = false }: EmptyStateProps) {
  if (compact) {
    return (
      <div className="flex-1 grow flex flex-col items-center justify-center gap-3 p-4 w-full h-full text-center select-none my-auto">
        ...
        <div className="mt-1">
          <p className="text-[12px] font-bold text-text-primary tracking-wider">Strat Agent Ready</p>
  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeInUp} className="w-full max-w-[420px] px-4 flex items-center justify-center shrink-0 mb-2">
