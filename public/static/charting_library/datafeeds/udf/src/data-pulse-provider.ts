...
export class DataPulseProvider implements IDataPulseProvider {
	...
	private _createTimerIfRequired(): void {
		if (this._updateTimer === null) {
			this._updateTimer = window.setInterval(this._updateData.bind(this), this._updateFrequency);
		}
	}

	private _destroyTimer(): void {
		if (this._updateTimer !== null) {
